...
public class Eye_doctor extends AppCompatActivity {
    ...
    private void firebaseDoctorSearch(String searchTxt) {
       //copy start
        Toast.makeText(Eye_doctor.this,"Start search",Toast.LENGTH_LONG).show();
            ...
            FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<model, Eye_doctor.PackageViewHolder>(options) {

                @Override
                public Eye_doctor.PackageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                    ...
                    return new Eye_doctor.PackageViewHolder(view);
                }


                @Override
                protected void onBindViewHolder(Eye_doctor.PackageViewHolder holder, int position, model model) {
                    ...
                    holder.mView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent SinglePackageIntent = new Intent(Eye_doctor.this,DoctorPview.class);
    ...
    protected void onStart() {
        ...
        Query query = FirebaseDatabase.getInstance()
                .getReference()
                .child("doctor").orderByChild("doctorspecialist").equalTo("Eye");
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(query, model.class)
                        .build();
